...
private npc: NPCActor;
  ...
  private enemy_damage: number = 7.5;
  ...
  public override loadScene() {
    ...
    this.load.audio("music2", "hw4_assets/music/music2.wav");
  ...
  if (this.player.health < this.previousPlayerHealth) {
    ...
    if (this.initializeNPCsBool) {
      ...
      if (this.npcInitTimer <= 0) {
          this.initializeNPCs();
          this.experience = this.experience + 15;
          this.enemy_damage = this.enemy_damage +7.5;
          ...
          const damageIncreases = {
              ...
              3: 10  // Increase for enemy group 3
          };
 ...
 */
  ...
  protected initializeNPCs(): void {
    ...
    for (let i = 0; i < red.bugSpawnPoint.length; i++) {
        ...
        this.npc.speed = 10;
        this.npc.maxHealth = 40 + this.increaseEnemyHealth;
    ...
    this.increaseEnemyHealth = this.increaseEnemyHealth +3;
}
