...
export default class Controls extends Scene {
  ...
  public static BACKGROUND_KEY = "CONTROLS SCREEN"
  public static BACKGROUND_PATH = "hw4_assets/Screens/controls_screen.png"
  private background: Sprite;


  protected initBackground(): void {
    this.background = this.add.sprite(Controls.BACKGROUND_KEY, "CONTROLS SCREEN");
  ...
  public loadScene() {
    this.load.image(Controls.BACKGROUND_KEY, Controls.BACKGROUND_PATH);

  }

  public startScene() {
    const center = this.viewport.getCenter();
    this.addLayer("CONTROLS SCREEN", 1);
    this.initBackground();
