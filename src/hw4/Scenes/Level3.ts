...
export default class Level3 extends HW4Scene {
  ...
  private increaseEnemyHealth = 50;
  private experience = 250;
  private enemyAttributes = {
    ...
    3: { minDistance: 26, speed: 0.55, damage: 150, attackInterval: 2000 }    // Attributes for enemy battle group 3
};
...
private npc: NPCActor;
  ...
  private enemy_damage: number = 50;
  ...
  public override loadScene() {
    ...
    this.load.audio("music3", "hw4_assets/music/music3.wav");
  ...
  public override startScene() {
    ...
    this.emitter.fireEvent(GameEventType.PLAY_SOUND, { key: "music3", loop: true, holdReference: true });
  ...
  if (this.player.health < this.previousPlayerHealth) {
    ...
    if (this.initializeNPCsBool) {
      ...
      if (this.npcInitTimer <= 0) {
          ...
          this.enemy_damage = this.enemy_damage + 25;
 ...
 */
  ...
  protected initializeNPCs(): void {
    ...
    for (let i = 0; i < red.demonSpawnPoint.length; i++) {
        ...
        this.npc.speed = 10;
        this.npc.maxHealth = 150 + this.increaseEnemyHealth;
    ...
    this.increaseEnemyHealth = this.increaseEnemyHealth + 50;
